...
\typearea{10}	% Festlegung des Seitenspiegels gem. Koma. 4..groÃŸ, 9..klein
...
Dieses Adapter speichern intern nur eine Referenz auf den tatsächlichen Players. 
...
\lstinputlisting{./../IPlayer.hpp}

\subsection{MusicPlayerAdapter.hpp}
\lstinputlisting{./../MusicPlayerAdapter.hpp}

\subsection{MusicPlayerAdapter.cpp}
\lstinputlisting{./../MusicPlayerAdapter.cpp}

\subsection{MusicPlayer.hpp}
\lstinputlisting{./../MusicPlayer.hpp}

\subsection{MusicPlayer.cpp}
\lstinputlisting{./../MusicPlayer.cpp}

\subsection{Song.hpp}
\lstinputlisting{./../Song.hpp}

\subsection{Song.cpp}
\lstinputlisting{./../Song.cpp}

\subsection{VideoPlayerAdapter.hpp}
\lstinputlisting{./../VideoPlayerAdapter.hpp}

\subsection{VideoPlayerAdapter.cpp}
\lstinputlisting{./../VideoPlayerAdapter.cpp}

\subsection{VideoPlayer.hpp}
\lstinputlisting{./../VideoPlayer.hpp}

\subsection{VideoPlayer.cpp}
\lstinputlisting{./../VideoPlayer.cpp}

\subsection{Video.hpp}
\lstinputlisting{./../Video.hpp}

\subsection{Video.cpp}
\lstinputlisting{./../Video.cpp}

\subsection{EVideoFormat.hpp}
\lstinputlisting{./../EVideoFormat.hpp}
