...
\subsection{Aufwand}
	...
	\begin{itemize}
		...
		\item Simon Vogelhuber:  geschätzt 10 Ph / tatsächlich 5 Ph
	\end{itemize}
...
Im Klassendiagramm wurd als Patter das \textit{Observer Pattern} verwendet, da in diesem fall ein Fahzeug
